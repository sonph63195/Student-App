...
//        Button btnNext1 = findViewById(R.id.btnNext1);
    ...
    private View.OnClickListener clickToNextStep = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (currentNumber == 1) {
                showLayoutStep(R.layout.register_step_3, StateProgressBar.StateNumber.TWO, 2, R.id.btnConfirm, clickToConfirmRegister);
            } else if (currentNumber == 2) {
                showLayoutStep(R.layout.register_step_2, StateProgressBar.StateNumber.ONE, 1, R.id.btnNext2, clickToNextStep);
